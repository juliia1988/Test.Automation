...
test_witsml_empty_intervals()

@allure.feature('Send request to the WITSML send Email API')
@allure.story('Send request with invalid code params')
@allure.step

def test_witsml_invalid_code():
